...
const NAV_ITEMS: Record<Role, NavItem[]> = {
  ADMIN: [
    ...
    { href: "/admin/produccion", label: "Producción", icon: "restaurant_menu" },
    { href: "/admin/logistica", label: "Logística", icon: "local_shipping" },
    { href: "/admin/finanzas", label: "Finanzas", icon: "analytics" },
    { href: "/admin/proveedores", label: "Proveedores", icon: "inventory_2" },
    { href: "/admin/feedback", label: "Feedback", icon: "star" },
    { href: "/admin/usuarios", label: "Usuarios", icon: "groups" },
    { href: "/admin/reportes", label: "Reportes", icon: "bar_chart" },
    { href: "/admin/configuracion", label: "Configuración", icon: "settings" },
  ],
  CLIENTE: [
    { href: "/cliente", label: "Mi Panel", icon: "dashboard" },
    { href: "/cliente/pedidos", label: "Mis Pedidos", icon: "receipt_long" },
    { href: "/cliente/eventos", label: "Mis Eventos", icon: "event" },
    { href: "/cliente/facturas", label: "Facturas", icon: "payments" },
    { href: "/cliente/feedback", label: "Calificaciones", icon: "star" },
  ],
  CHEF: [
    { href: "/chef", label: "Cocina", icon: "dashboard" },
    { href: "/chef/produccion", label: "Producción", icon: "restaurant_menu" },
    { href: "/chef/ingredientes", label: "Ingredientes", icon: "inventory_2" },
  ],
  STAFF: [
    { href: "/staff", label: "Mi Panel", icon: "dashboard" },
    { href: "/staff/asignaciones", label: "Asignaciones", icon: "event" },
    { href: "/staff/entregas", label: "Entregas", icon: "local_shipping" },
  ],
  PROVEEDOR: [
    { href: "/proveedor", label: "Mi Panel", icon: "dashboard" },
    { href: "/proveedor/pedidos", label: "Pedidos", icon: "receipt_long" },
    { href: "/proveedor/catalogo", label: "Catálogo", icon: "inventory_2" },
  ],
  FINANZAS: [
    { href: "/finanzas", label: "Dashboard", icon: "dashboard" },
    { href: "/finanzas/facturacion", label: "Facturación", icon: "payments" },
    { href: "/finanzas/pagos", label: "Pagos", icon: "credit_card" },
    { href: "/finanzas/reportes", label: "Reportes", icon: "bar_chart" },
  ],
};
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
      ...
      <div className="mt-auto flex flex-col gap-1 border-t border-outline-variant/10 pt-4">
        {/* New Event Button */}
        <button className="w-full bg-gradient-to-r from-primary-container to-primary text-white rounded-xl py-3 px-4 text-sm font-bold shadow-md hover:brightness-110 transition-all active:scale-95 flex items-center justify-center gap-2 mb-4">
