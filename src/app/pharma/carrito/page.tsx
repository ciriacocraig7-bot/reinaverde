        ...
        <section className="max-w-[1400px] mx-auto px-6 sm:px-10 py-24 sm:py-32 grid place-items-center min-h-[60vh]">
          <div className="max-w-md text-center">
            ...
            <h2 className="mt-4 font-display font-light text-5xl sm:text-6xl tracking-[-0.025em] leading-[0.95] text-ink">
              Aún no has
              <br />
              <span className="italic">elegido</span>
              <br />
              ninguna fórmula.
            </h2>
            <Link
            ...
            {step === 1 && (
              <div className="space-y-6 max-w-2xl">
                ...
                <Input id="notes" label="Notas (opcional)" value={shipping.notes}
                  ...
                  hint="Ej: factura con NIT 900.xxx.xxx · empresa." />
              </div>
            )}
              ...
              <div className="space-y-8 max-w-2xl">
                <div className="border border-ink/15 p-8 bg-cream-warm">
                  ...
                  <p className="mt-3 font-serif italic text-[15px] text-ink/65 leading-snug">
                    Será redirigido a la pasarela segura de Bold. Tarjeta crédito/débito,
                    PSE, Nequi y Daviplata. Firma de integridad SHA-256.
                  </p>
                  <div className="mt-6">
                    <BoldPaymentButton
              ...
              {step === 1 && (
                <>
                  <button
                    ...
                    className="block w-full h-12 bg-iris text-cream font-sans text-[14px] tracking-tight rv-press hover:bg-iris-deep disabled:opacity-50"
                  >
