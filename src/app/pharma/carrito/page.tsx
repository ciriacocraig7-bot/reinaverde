        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {step === 2 && boldConfig && (
              <div className="bg-surface-container-lowest rounded-2xl p-6 border border-outline-variant/10 shadow-sm space-y-6">
                <h2 className="text-lg font-bold text-on-surface flex items-center gap-2">
                  <span className="material-symbols-outlined text-violet-600">lock</span> Pago Seguro con Bold
                </h2>
                
                <div className="p-4 bg-violet-50 rounded-xl border border-violet-200 text-center">
                  <p className="text-sm text-violet-800 mb-2">Total a pagar</p>
                  <p className="text-3xl font-bold text-violet-900">{formatCurrency(total())}</p>
                </div>
                ...
                <div className="flex items-center gap-2 p-3 bg-violet-50/50 rounded-lg">
                  <span className="material-symbols-outlined text-violet-500 text-lg">verified</span>
                  <p className="text-xs text-violet-700">Pago procesado de forma segura por Bold.co — Tarjeta, PSE, Nequi, Daviplata</p>
                </div>
          ...
          <div className="bg-surface-container-lowest rounded-2xl p-6 border border-outline-variant/10 shadow-sm h-fit sticky top-8">
            ...
            <div className="mt-6 space-y-3">
              {step === 0 ? (
                <button onClick={() => setStep(1)} className="w-full py-3 px-6 bg-gradient-to-br from-violet-600 to-purple-800 text-white rounded-xl font-semibold shadow-sm hover:brightness-110 active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-2">
                  Continuar <span className="material-symbols-outlined text-lg">arrow_forward</span>
                </button>
              ) : step === 1 ? (
                <button onClick={handleCheckout} disabled={!canProceed || processing} className="w-full py-3 px-6 bg-gradient-to-br from-violet-600 to-purple-800 text-white rounded-xl font-semibold shadow-sm hover:brightness-110 active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-2">
